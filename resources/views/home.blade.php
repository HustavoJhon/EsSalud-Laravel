...
<div class="bg-gradient-to-r from-primary-700 to-primary-500 rounded-xl shadow-lg p-6 md:p-8 mb-6 text-white">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex gap-2 shrink-0">
            <a href="{{ route('procedures.create') }}" class="inline-flex items-center space-x-2 bg-white text-primary-700 px-4 py-2.5 rounded-lg font-medium text-sm hover:bg-primary-50 transition-colors shadow-sm">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                </svg>
                <span>Nuevo Trámite</span>
            </a>
            <a href="{{ route('chat.index') }}" class="inline-flex items-center space-x-2 bg-primary-600 text-white px-4 py-2.5 rounded-lg font-medium text-sm hover:bg-primary-800 transition-colors border border-primary-400">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
