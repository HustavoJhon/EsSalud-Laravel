...
class ProcedureController extends Controller
{
    ...
    public function apiShow(Procedure $procedure)
    {
        $procedure->load([
    ...
    public function apiMy(Request $request)
    {
    ...
    public function apiHistory(Procedure $procedure)
    {
    ...
    public function apiDocuments(Procedure $procedure)
    {
